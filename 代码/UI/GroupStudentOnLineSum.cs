...
namespace UI
{
    public partial class GroupStudentOnLineSum : Form
    {
        public GroupStudentOnLineSum()
        {
            InitializeComponent();
        }

        private void dateViConten_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }
        //实例化创建BLL层的工厂
        FactoryBLL factBLL = new FactoryBLL();
        private void GroupStudentOnLineSum_Load(object sender, EventArgs e)
        {
            #region 字段
            //字段
        ...
        private void GroupStudentOnLineSum_FormClosing(object sender, FormClosingEventArgs e)
        {
            QueryOperton.groupStudentLine = null;
        }
